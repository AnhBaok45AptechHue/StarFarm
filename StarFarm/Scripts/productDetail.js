...
function search() {
    ...
    inputText = input.value.toUpperCase();
   	divsearch.innerHTML='<div id="productsearch" class="row row-cols-1 row-cols-md-3 g-6">'+
						'</div>';
	var divsearchproduct= document.getElementById("productsearch");
...
var url_string = window.location.href
		...
		document.getElementById("image").src = '../image/'+product[i].image1;
		document.getElementById("titlename").innerText =  product[i].name;
		document.getElementById("breadcrumbname").innerText =  product[i].name;
		document.getElementById("image").src = '../image/'+product[i].image1;
		document.getElementById("image2").src = '../image/'+ product[i].image2;
		document.getElementById("image").alt = product[i].name;
		document.getElementById("image2").alt = product[i].name;
		document.getElementById("productname").innerText =  product[i].name;
		document.getElementById("description").innerHTML =product[i].description;
		document.getElementById("price").innerText = product[i].price;
...
// recommend product
		 for ( var j = 0  ; j < 5; j++) {
		 		...
		 		y = Math.floor(Math.random()*product.length);
		 		var x = product[y];
		 		div.innerHTML += 
				 	'<div class="col-4  ">'+
			            '<div class="card">'+
 ...
 document.getElementById("review").innerText = Math.floor(Math.random() * 100) ;
